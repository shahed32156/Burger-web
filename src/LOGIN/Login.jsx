                 ...
                 {/* Login start */}
                    ...
                    <div className='mt-8'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-3xl font-[Matemasie]'>Login</h1>
                            </div>
                           ...
                           <form onSubmit={handleSubmit} className='flex flex-col gap-6 mt-10' action="">
                                ...
                                <div className='flex justify-center relative'>
                                     ...
                                     <input className='w-full mx-5 sm:w-[320px] pl-7 pb-1 text-[18px] border-b-2 bg-transparent border-white focus:outline-none' 
                                     placeholder='Password' type="password" required
                                     name="password" id="" onChange={handlePass} value={pass} />
                                     <i class="fa-solid fa-lock text-xl absolute bottom-1 left-5 sm:left-10"></i>

                                </div>

                                <div className='flex relative pl-5 sm:pl-10'>

                                    <button onClick={() => setShow("forgot_pass") } className='hover:underline font-bold'>Forgot password?</button>

                                </div>

                                <div className='flex justify-center relative'>

                                    <button className='h-[40px] w-[120px] text-xl bg-orange-500 rounded-md duration-500 hover:bg-orange-600'>Login</button>

                                </div>

                                <div className='flex items-center justify-center relative py-4 rounded-t-3xl bg-orange-500'>

                                    <p className=' font-bold'>Don't have an account? <button onClick={() => setShow("registration") } className='hover:underline cursor-pointer'>Registration</button></p>
